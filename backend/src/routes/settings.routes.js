...
import { getSettings, updateSettings, updateDeviceLock, updateScanPassword, activateScanTerminal, updateWorkTimeSettings } from "../controllers/settings.controller.js"
...
router.put("/work-time", authMiddleware, roleMiddleware("admin"), updateWorkTimeSettings)
